...
const dataDoEvento = new Date("may 21, 2026 12:00:00");
...
const contaHoras = setInterval( function () {
    ...
    document.getElementById('data').innerHTML = `${diasAteEvento}d ${horasAteEvento}h ${minutosAteEvento}m ${segundosAteEvento}s`
}, 1000)